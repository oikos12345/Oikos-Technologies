...
// VIDEO IMPORTS
import AboutUsBG from '../assets/media/ABOUT US BG.mp4';
import MissionVisionBG from '../assets/media/MISSION VISSION BG.mp4';

// IMAGE IMPORTS
import meetOurTeamImage from '../assets/media/MEET OUR TEAM.jpg';

import MrRubioImage from '../assets/media/Mr. Rubio.jpg';
import MurilloImage from '../assets/media/Murillo.jpg';
...
const About: React.FC = () => {
  return (
    <>
      ...
      style={{ backgroundImage: `url(${meetOurTeamImage})` }}
      >
        ...
        <div className="main-container">
          ...
          <div className="firstPerson">
            <div className="personCard">
              <img src={MrRubioImage} alt="Sole Proprietor" />
          ...
          <div className="firstPerson">
            ...
            <div className="personCard">
              <img src={MurilloImage} alt="Operations Head" />
